...
menu = {"Value": {"Burger": ["Beef burger", 5.69],
        ...
        "Super": {"Burger": ["Cheeseburger", 6.69],
                  ...
                  "Side": ["Smoothie", 2],
                  "Total cost": 10.69}}
combo_names = ["Value", "Cheezy", "Super"]
...
def find_combo():
    find_show = eg.buttonbox("Would you like to find a combo or show the menu", "Pathway",
                             choices=["Find combo", "Show menu"])
    if find_show == "Find combo":
        choice = eg.buttonbox("Which combo would you like to find", "Combo directory", choices=combo_names)
        combo = menu.get(choice)
        print(combo)
